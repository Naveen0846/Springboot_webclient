...
//	public static final String ROLE_SAVE = "Role saved successfully";
	...
	public static final String PRODUCT_SAVE_SUCCESS = "Product placed Successfully.";
	public static final String PRODUCT_SAVE_FAILED = "ERROR while saving product details, Please Try Again";
	...
	public static final String PRODUCT_STATUS_ACTIVE = "product Details is Active";
	public static final String PRODUCT_STATUS_INACTIVE = "product Details is InActive";
	public static final String PRODUCT_EMAIL_SEND_FAILED = "ERROR while sending Email, Please Try Again";
